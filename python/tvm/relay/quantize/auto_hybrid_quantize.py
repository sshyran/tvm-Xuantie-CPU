...
class ModelQuantizationInfo(object):
    ...
    def update_hybrid_layers(self, name="cos_similarity", threshold=0.99):
...
def load_lib(module_factory, output_dir):
    ...
    ref_x86_path = os.path.join(source_dir, "install_nn2", "lib", "libshl_ref_x86.a")
    lib_path = os.path.join(output_dir, "quant.so")
    kwargs = {}
    kwargs["options"] = ["-O2", "-g", "-I" + include_path, ref_x86_path]
    kwargs["cc"] = "gcc"
