...
def _max_pool2d_location(input_data, out_buf, kernel_h, kernel_w, stride_h, stride_w, pad_h, pad_w):
...
def max_pool2d_location(
    ...
    tmp_h = height_ + 2 * pad_h - kernel_h
    tmp_h_ = te.div(tmp_h, stride_h)
    tmp_w = width_ + 2 * pad_w - kernel_w
    ...
    top_mask = te.extern(
        ...
        lambda ins, outs: _max_pool2d_location(
            ins[0], outs[0], kernel_h, kernel_w, stride_h, stride_w, pad_h, pad_w
        ),
    )
