 ...
 * executed on.
 */
void HHBRuntime::Init(tvm::runtime::Module module, const std::vector<Device>& ctxs) {
  module_ = module;
  ctxs_ = ctxs;
}
...
std::vector<Device> HHBGetAllContext(const TVMArgs& args) {
...
Module HHBRuntimeCreate(const tvm::runtime::Module& m, const std::vector<Device>& ctxs) {
