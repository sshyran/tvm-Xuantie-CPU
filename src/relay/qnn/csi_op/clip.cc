...
Expr MakeQnnCSIClip(Expr data, double input_scale, int32_t input_zero_point, double output_scale,
                    int32_t output_zero_point, double a_min, double a_max, DataType out_dtype,
