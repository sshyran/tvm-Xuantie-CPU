...
Expr MakeQnnCSISegmentMax(Expr data, Expr segment_ids, double input_scale, int32_t input_zero_point,
                          double output_scale, int32_t output_zero_point, int32_t length,
...
Expr MakeQnnCSISegmentMin(Expr data, Expr segment_ids, double input_scale, int32_t input_zero_point,
                          double output_scale, int32_t output_zero_point, int32_t length,
                          DataType out_dtype, Array<IndexExpr> max_values,
                          Array<IndexExpr> min_values, String layer_name) {
  auto attrs = make_object<QnnCSISegmentAttrs>();
...
Expr MakeQnnCSISegmentMean(Expr data, Expr segment_ids, double input_scale,
                           int32_t input_zero_point, double output_scale, int32_t output_zero_point,
                           int32_t length, DataType out_dtype, Array<IndexExpr> max_values,
                           Array<IndexExpr> min_values, String layer_name) {
  auto attrs = make_object<QnnCSISegmentAttrs>();
  attrs->input_scale = input_scale;
  attrs->input_zero_point = input_zero_point;
...
Expr MakeQnnCSISegmentProd(Expr data, Expr segment_ids, double input_scale,
                           int32_t input_zero_point, double output_scale, int32_t output_zero_point,
                           int32_t length, DataType out_dtype, Array<IndexExpr> max_values,
                           Array<IndexExpr> min_values, String layer_name) {
  auto attrs = make_object<QnnCSISegmentAttrs>();
...
Expr MakeQnnCSISegmentSum(Expr data, Expr segment_ids, double input_scale, int32_t input_zero_point,
                          double output_scale, int32_t output_zero_point, int32_t length,
                          DataType out_dtype, Array<IndexExpr> max_values,
                          Array<IndexExpr> min_values, String layer_name) {
  auto attrs = make_object<QnnCSISegmentAttrs>();
